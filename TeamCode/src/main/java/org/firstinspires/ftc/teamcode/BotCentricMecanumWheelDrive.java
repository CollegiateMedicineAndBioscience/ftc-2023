...
@TeleOp(name="Bot Centric Mecanum Drive", group="Linear Opmode")
@Disabled
public class BotCentricMecanumWheelDrive extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Initialize the hardware variables. The names are retrieved from the configure robot menu.
        // The names in the code must match the names of the motors in the hardware mapping
        ...
        while (opModeIsActive()) {
            ...
            // Calculate motor powers based off of game pad inputs
